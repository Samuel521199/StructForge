...
const (
	...
	UserService_VerifyEmail_FullMethodName             = "/api.user.v1.UserService/VerifyEmail"
	UserService_ResendVerificationEmail_FullMethodName = "/api.user.v1.UserService/ResendVerificationEmail"
	...
	UserService_RequestPasswordReset_FullMethodName    = "/api.user.v1.UserService/RequestPasswordReset"
	UserService_ResetPassword_FullMethodName           = "/api.user.v1.UserService/ResetPassword"
)
